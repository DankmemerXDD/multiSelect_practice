...
function selectOption(option: SelectOption) {
    if (multiple) {
        ...
        if (selectedValues.some(o => o.value === option.value)) {
            onChange(selectedValues.filter(o => o.value !== option.value));
        } else {
...
function isOptionSelected(option: SelectOption) {
    return multiple
        ? (value as SelectOption[]).some(o => o.value === option.value)
        : (value as SelectOption | undefined)?.value === option.value;
}
